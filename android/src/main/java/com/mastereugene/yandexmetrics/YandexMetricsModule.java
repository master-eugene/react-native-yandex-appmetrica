package com.mastereugene.yandexmetrics;
...
public class YandexMetricsModule extends ReactContextBaseJavaModule {

    private static String TAG = "YandexMetrics";

    private final ReactApplicationContext reactContext;

    public YandexMetricsModule(ReactApplicationContext reactContext) {
        super(reactContext);
